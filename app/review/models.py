...
class ReviewManager(models.Manager):
    ...
    def _create_new_review(self, creator, executor,
        ...
        if executor != job.executor:
            raise ValueError("The review executor must match with the"
                             " job executor")
...
class Review(models.Model):
    ...
    executor = models.ForeignKey(get_user_model(),
                                 related_name='review_executor',
                                 on_delete=models.CASCADE)
    job = models.ForeignKey(Job, related_name='reviewed_job',
                            on_delete=models.CASCADE)
